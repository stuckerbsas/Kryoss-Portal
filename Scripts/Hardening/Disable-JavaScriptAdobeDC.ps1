...
<#
.SYNOPSIS
    Disables JavaScript execution in Adobe Acrobat Reader DC.

.DESCRIPTION
    Sets the bDisableJavaScript registry value to prevent JavaScript from running
    inside Adobe Acrobat Reader DC. JavaScript in PDF files is a common attack vector
    used for exploitation and malware delivery.
...
.EXAMPLE
    .\Disable-JavaScriptAdobeDC.ps1
    Applies the hardening setting silently (NinjaRMM/Intune deployment).

.EXAMPLE
    .\Disable-JavaScriptAdobeDC.ps1 -WhatIf
...
# ── Constants ──────────────────────────────────────────────
$SCRIPT_NAME    = "Disable-JavaScriptAdobeDC"
$SCRIPT_VERSION = "1.0"
