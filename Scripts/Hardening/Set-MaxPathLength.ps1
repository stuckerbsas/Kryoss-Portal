...
<#
.SYNOPSIS
    Enables Windows long path support beyond the 260-character limit.

.DESCRIPTION
    Sets the LongPathsEnabled registry value to allow applications that support
    long paths to work with paths exceeding 260 characters. This improves
    compatibility with modern applications and avoids path truncation errors.
