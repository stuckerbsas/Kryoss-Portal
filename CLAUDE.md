...
|-----------|---------|-------|----------|
| **API** | 1.40.0 | `KryossApi.csproj` `<Version>` | `GET /v2/version` (no auth) |
| **Portal** | 1.23.10 | `KryossPortal/package.json` `"version"` | Sidebar footer "Powered by Kryoss vX.Y.Z" |
| **Agent** | 2.15.0 | `KryossAgent.csproj` `<Version>` | Registry `HKLM\SOFTWARE\Kryoss\Agent\Version` |
